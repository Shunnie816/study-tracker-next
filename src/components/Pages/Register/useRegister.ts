...
export function useRegister() {
  ...
  const [registerAlertShown, setRegisterAlertShown] = useState<boolean>(false);
  ...
  const handleOpenEditDialog = useCallback(
    (id: string) => {
      setEditTargetId(id);
      /** 編集ダイアログが開いたら、アラートをすべて消す */
      setRegisterAlertShown(false);
  ...
  return {
    ...
    textbooks,
    showRegisterAlert,
    setShowRegisterAlert: setRegisterAlertShown,
    isDeleteSuccess,
    handleSnackbarClose,
    isEditSuccess,
    isEditDisabled,
