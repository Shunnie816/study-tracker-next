...
function AppIcon() {
  return (
    <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
      <rect x="5" y="4" width="18" height="20" rx="3" fill="white" opacity=".95" />
      <line x1="9" y1="10" x2="19" y2="10" stroke="#4361EE" strokeWidth="2" strokeLinecap="round" />
      <line x1="9" y1="14" x2="19" y2="14" stroke="#4361EE" strokeWidth="2" strokeLinecap="round" />
      <line x1="9" y1="18" x2="15" y2="18" stroke="#4361EE" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
      ...
      <Box sx={{ width: "100%", maxWidth: 390, overflow: "hidden" }}>
        ...
        >
          ...
          >
            ...
            <Typography
              sx={{ fontSize: 11, color: "#9194AF", mb: "18px", textAlign: "center" }}
            >
            ...
            {/* Divider */}
            <Box
              sx={{ display: "flex", alignItems: "center", gap: "8px", my: "14px" }}
            >
